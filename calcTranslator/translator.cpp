...
int main()
{
    ...
    outfile.open("output_heredoc.bat");
    ...
    while (!last)
    {
        ...
        if (last)
        {
            cout << "FILE:@echo.q" << endl;
            outfile << "@echo.q" << endl << endl;
        }
        else
        {
            cout << "FILE:@echo.c" << endl;
            outfile << "@echo.c" << endl << endl;
        }
        i++;
    }
    ...
    cout << "FILE:) | ..\\main.exe" << endl;
    outfile << ") | ..\\main.exe" << endl;
...
int parseFormula(ofstream& fout,const string& str, int start, int stop,vector<string>& vars)
{
    ...
    if (isVariable(str)!=-1)
    {
        cout << "FILE:@echo.u" << endl;
        fout << "@echo.u" << endl;
        cout << "FILE:@echo.v" << endl;
        fout << "@echo.v" << endl;
        cout << "FILE:@echo." << str[0] << endl;
        fout << "@echo." << str[0] << endl;
...
void hereDocPreamble(ofstream& fout)
{
    cout << "FILE:(" << endl;
    fout << "(" << endl;
    fout << "@echo.c #this program is always calc mode" << endl;
}
...
{
    cout << "FILE:@echo.b" << endl;
    fout << "@echo.b" << endl;
    cout << "FILE:@echo." << op << endl;
    fout << "@echo." << op << endl;
    string sub;
    int lstart = 1;
